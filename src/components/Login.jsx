...
const Login = () => {
    ...
    const {
      ...
      const onSubmit = async (data) => {
        ...
        await axios.post('http://localhost:4003/user/login', userInfo)
          .then((res) => {
                ...
                <div className="modal-box">
                    ...
                    <div>
                        ...
                        <div className='flex justify-around mt-4'>
                            <button className='bg-blue-500 text-white px-3 py-1 rounded-md hover:bg-blue-700 duration-300'>Login </button>
                            <p>Not Registered? 
